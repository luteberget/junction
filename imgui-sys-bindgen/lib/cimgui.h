...
enum ImGuiDockNodeFlags_
{
    ...
    ImGuiDockNodeFlags_AutoHideTabBar = 1 << 7
};
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags__OptionsDefault = ImGuiColorEditFlags_Uint8|ImGuiColorEditFlags_DisplayRGB|ImGuiColorEditFlags_PickerHueBar
};
...
CIMGUI_API ImGuiID igDockSpaceOverViewport(ImGuiViewport* viewport,ImGuiDockNodeFlags dockspace_flags,const ImGuiWindowClass* window_class);
